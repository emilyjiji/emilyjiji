...
|------------------------------------------------------|--------------------------------------------------|-------------------|
| Uniswap v4 Hook for Liquidity Optimization via Restaking             | ![Solidity](https://img.shields.io/badge/-Solidity-grey) ![Javascript](https://img.shields.io/badge/-Javascript-grey)  | Feb 2024 - Present |
